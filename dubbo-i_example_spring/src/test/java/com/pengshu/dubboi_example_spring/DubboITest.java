...
public class DubboITest {
	...
	public void testSayHelloImpl() {
		try {
			...
			//RpcGenericService sayHelloService = RpcGenericService.Create("com.pengshu.dubboi_example_spring.service.SayHello", "1.0.0", DubboI_Configuration.Loadbalance.random); // 获取service的同时，指定客户端的负载均衡
