package com.pengshu.dubboi_example_web.util;
...
import com.pengshu.dubboi_example_web.exception.HttpFailException;
...
public class HttpUtil {
	...
	// get 获取 rest 资源
	public static String do_get(String url, Map<String, String> params, Map<String, String> headers) throws IOException,HttpFailException {
	...
	public static String do_post(String url, Map<String, String> params, Map<String, String> headers) throws IOException,HttpFailException {
	...
	public static String do_post_json(String url, Map<String, Object> params, Map<String, String> headers) throws IOException,HttpFailException {
		Builder builder = new Request.Builder().url(url);
		add_headers(builder, headers);
		Request request = builder.post(RequestBody.create(MEDIA_TYPE_JSON, objectMapper.writeValueAsString(params))).build();
		Response response = client.newCall(request).execute();
		if (response.isSuccessful()) {
			return response.body().string();
		} else {
	...
	public static void do_post_json_async(String url, Map<String, Object> params, Callback callback, Map<String, String> headers) throws IOException {
		Builder builder = new Request.Builder().url(url);
		add_headers(builder, headers);
		Request request = builder.post(RequestBody.create(MEDIA_TYPE_JSON, objectMapper.writeValueAsString(params))).build();
		if (callback == null) {
	...
	public static String do_post_form_data(String url, Map<String, String> params, Map<String, String> headers) throws IOException,HttpFailException {
		Builder builder = new Request.Builder().url(url);
		add_headers(builder, headers);
